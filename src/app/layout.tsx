...
export default function RootLayout({
	...
	return (
		<html lang="en">
			<body className={`${inter.className} bg-ctp-base`}>
				<div className="flex flex-row justify-center w-full h-full space-x-2 p-5">
					<Image
						src="/tgt.png"
						alt="logo"
					...
					<div className="flex justify-end w-full h-full">
						{links.map((link) => (
							<Link
								href={link.href}
								key={link.href}
								className="text-ctp-mauve hover:underline p-5"
							>
								{link.icon}
								{link.name}
							</Link>
