    ...
    return (
      <main className="min-h-screen flex-col items-center justify-between p-5 mx-auto overflow-y-auto">
        ...
        <div className="flex flex-row justify-end w-full h-full space-x-5 -translate-y-10 p-2 text-ctp-sky">
          <Link className="hover:underline" href="/" aria-label="Home">Home</Link>
        ...
        <div className="text-3xl text-ctp-text font-bold space-y-1">Contact</div>
        ...
        You can contact me at:
            ...
            I&apos;m very willing to work with you on a project! If there&apos;s anything you want me to work on, just contact me and I might be interested!
        </div>
        </div>
        </main>
        )}